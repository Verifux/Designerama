  ...
  return (
    <section id="verifux" className="border-b border-line py-32">
      <div className="mx-auto max-w-container px-5 sm:px-8">
        <RevealOnScroll
          className="grid grid-cols-1 gap-10 rounded-lg2 border border-line p-7 sm:p-14 lg:grid-cols-[1.1fr_0.9fr]"
          style={{ background: "linear-gradient(135deg, color-mix(in srgb, var(--accent) 7%, var(--paper)), var(--paper))" }}
          y={20}
        >
          <div>
